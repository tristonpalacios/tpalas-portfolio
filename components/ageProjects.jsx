      ...
      white AgeSubHeading"
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="card-body">
                ...
                <ul>
                  <li className="white">Dozens of self-made custom art assets</li>
        ...
        >
          <div className="row">
            <div className="col-md-6">
              <div className="card-body">
                <h1 className="card-title white">Virtual Marvel Encyclopedia</h1>
                {/* <p className="card-text">
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="card-body">
              ...
              <h3 className="BoldFont white">Project Highlights</h3>
              <ul>
                <li className="white">Custom art assets for Hype Meter, Logo, and Background</li>
                <li className="white">Mapbox Implementation</li>
                <li className="white">Created utilizing team SCRUM workflow</li>
          ...
          <div className="col-md-6 ">
            <div className="card-body">
              ...
              <ul>
                ...
                <li className="white">Fully Functional Dev Build created in under 10 days</li>
                <li className="white">Created utilizing team SCRUM workflow</li>
                <li className="white">
