    ...
    return (
      ...
      >
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="card-body">
              <h1 className="card-title">Unlocking Communities </h1>
              ...
              <h3 className="BoldFont">Project Highlights</h3>
              <ul>
                <li>Created in 72 hours utilizing an 8 team SCRUM workflow</li>
                <li>Fully developed backend heirarchy that allows admis to create modules, lessons, and quizzes.</li>
                <li>Styled with custom components and react bootstrap</li>
                <li>Developed as a light weight solution to better suite the unique tech climate of Haiti</li>
              </ul>
              <span className="paddingButton">
                <Button className="varButton">
